...
public class Electroshield extends AbstractDynamicCard {


    // TEXT DECLARATION

    public static final String ID = RobotSpaceExplorerMod.makeID(Electroshield.class.getSimpleName());
